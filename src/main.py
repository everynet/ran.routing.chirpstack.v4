...
class RanSyncDevices(chirpstack.MultiApplicationDeviceList):
    def __init__(
        ...
        super().__init__(chirpstack_api, tenant_id, tags)
...
class RanSyncMulticastGroups(chirpstack.MultiApplicationMulticastGroupList):
    def __init__(
        ...
        super().__init__(chirpstack_api, tenant_id)
...
async def main():
    ...
    ran_chirpstack_devices = RanSyncDevices(ran_core, chirpstack_api, settings.CHIRPSTACK_TENANT_ID, tags)
    ...
    ran_chirpstack_multicast_groups = RanSyncMulticastGroups(ran_core, chirpstack_api, settings.CHIRPSTACK_TENANT_ID)
